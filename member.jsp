...
<body>
    ...
    <form action="./2_member_ok.jsp" method="post" name="regform" id="regform" onsubmit="return sendit()">
        ...
        <p>취미 : <label>드라이브<input type="checkbox" name="hobby" value="드라이브"></label> <label>영화감상<input type="checkbox"
                    name="hobby" value="영화감상"></label> <label>쇼핑<input type="checkbox" name="hobby" value="쇼핑"></label>
            <label>운동<input type="checkbox" name="hobby" value="운동"></label> <label>게임<input type="checkbox"
                    name="hobby" value="게임"></label></p>
        <p>주민등록번호 : <input type="text" name="ssn1" id="ssn1" maxlength="6" onkeyup="moveFocus()" onkeydown="ssnChange()"> - <input type="text" name="ssn2" id="ssn2"maxlength="7" onkeyup="ssnChange()"> <input type="button" value="주민등록번호 검증" onclick="ssnCheck()"></p>
        ...
        <p>세부주소 : <input type="text" name="address2" id="sample6_detailAddress"></p>
        <p>참고항목 : <input type="text" name="address3" id="sample6_extraAddress"></p>
        <p><input type="submit" value="가입 완료"> <input type="reset" value="다시작성"><input type="button" value="로그인" onclick="location.href='./login.jsp'">
        </p>
    </form>
</body>
